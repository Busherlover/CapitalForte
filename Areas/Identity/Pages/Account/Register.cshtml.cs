    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Set user properties from the InputModel
        ...
        private ApplicationUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Application)}'. " +
                    $"Ensure that '{nameof(Application)}' is not an abstract class and has a parameterless constructor, or alternatively " +
